...
--
-- Host: localhost
-- Generation Time: Sep 29, 2025 at 03:14 AM
...
CREATE TABLE IF NOT EXISTS `packages` (
  ...
  `packages_inclusion_exclusion_checked_type` varchar(50) NOT NULL,
  `packages_optional_add_on_checked_type` varchar(50) NOT NULL,
  `packages_special_requirment_checked_type` varchar(50) NOT NULL,
  `packages_payment_policies_checked_type` varchar(50) NOT NULL,
  `packages_terms_conditions_checked_type` varchar(50) NOT NULL,
...
(2, 3, '2025-09-27', '2025-09-29', 2, 2, 2, 2, 2, 3, 'df', 1, 'Super admin', '2025-09-27', '08:18:21', 1);
