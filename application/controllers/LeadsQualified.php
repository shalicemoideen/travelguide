...
class LeadsQualified extends MY_Controller {
	public $table = 'leads';
	...
	public function __construct()
	{
	    ...
	    $this->currentusertype = $this->session->userdata('user_type');
            ...
            $this->load->model('LeadsQualified_model');
	}
	...
	public function index()
	{
		...
		$template['body'] = 'LeadsQualified/list';
		$template['script'] = 'LeadsQualified/script';
	...
	public function get_b2c(){
    	...
    	$data = $this->LeadsQualified_model->getManualB2CLeadsTable($param);
	...
	public function get_meta(){
    	...
    	$data = $this->LeadsQualified_model->getMetaLeadsTable($param);
    	$json_data = json_encode($data);
    	echo $json_data;
    }
	...
	public function get_b2b(){
    	...
    	$data = $this->LeadsQualified_model->getB2BLeadsTable($param);
    	$json_data = json_encode($data);
    	echo $json_data;
    }
