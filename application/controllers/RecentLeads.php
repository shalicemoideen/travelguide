...
class RecentLeads extends MY_Controller {
	public $table = 'leads';
	...
	public function __construct()
	{
	    ...
	    $this->currentusertype = $this->session->userdata('user_type');
            ...
            $this->load->model('RecentLeads_model');
	}
	...
	public function index()
	{
		...
		$template['body'] = 'RecentLeads/list';
		$template['script'] = 'RecentLeads/script';
	...
	public function get_b2c(){
    	...
    	$data = $this->RecentLeads_model->getManualB2CLeadsTable($param);
	...
	public function get_meta(){
    	...
    	$data = $this->RecentLeads_model->getMetaLeadsTable($param);
    	$json_data = json_encode($data);
    	echo $json_data;
    }
	...
	public function get_b2b(){
    	...
    	$data = $this->RecentLeads_model->getB2BLeadsTable($param);
    	$json_data = json_encode($data);
    	echo $json_data;
    }
