...
class LeadsNotQualified extends MY_Controller {
	public $table = 'leads';
	...
	public function __construct()
	{
	    ...
	    $this->currentusertype = $this->session->userdata('user_type');
            ...
            $this->load->model('LeadsNotQualified_model');
	}
	...
	public function index()
	{
		...
		$template['body'] = 'LeadsNotQualified/list';
		$template['script'] = 'LeadsNotQualified/script';
	...
	public function get_b2c(){
    	...
    	$data = $this->LeadsNotQualified_model->getManualB2CLeadsTable($param);
	...
	public function get_meta(){
    	...
    	$data = $this->LeadsNotQualified_model->getMetaLeadsTable($param);
    	$json_data = json_encode($data);
    	echo $json_data;
    }
	...
	public function get_b2b(){
    	...
    	$data = $this->LeadsNotQualified_model->getB2BLeadsTable($param);
    	$json_data = json_encode($data);
    	echo $json_data;
    }
