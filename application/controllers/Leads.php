...
class Leads extends MY_Controller {
    ...
    private $meta_page_access_token = 'EAAVTcbJT5Q0BQxopa2I9igkAYp1LGWWlXF6cdQJ7v0EKFXkui37IgSDG5pEvk5l0gjoZB5ZBimG33Ssv6xkEAmvZCWYeuHyv44ezXuM7uuUpDZBERDkZAdvdYsX306j58dsqqFvXqxkwdVGsrIDhVt2cDyaVjZAQjTkE33EaykzvhDBjTVI1A4x8yEIOJWcPzZCbipEPoeWAc8To3xaIK6R6vwtYI28ner1vOhzadIpgFhn0tWHvjEdwwzF';
...
// }
	public function index()
	{
		...
		// $template['packages'] = $this->Leads_model->fetch_packages();
...
public function meta_webhook()
{
    ...
    private function save_meta_lead_to_leads_table($leadData, $page_id, $form_id, $ad_id)
    {
        ...
        $insert = array(
            ...
            'leads_number'              => $this->generate_meta_lead_number(),
            'lead_type'                 => 'Meta Lead',
...
// print_r($propertyDayMap);die;
    ...
    if (!empty($day_ids)) {
        ...
        foreach ($day_ids as $i => $day_id) {
            ...
            // If date range shorter than days list, fallback safely
            $accDate = isset($dateMap[$i]) ? $dateMap[$i]['date'] : null;
            $accDay  = isset($dateMap[$i]) ? $dateMap[$i]['day']  : null;

            // ✅ map property day by row index -> day number
            $dayNo = $i + 1; // Day 1, Day 2, Day 3...
            ...
            $insertData[] = array(
                ...
                // ✅ NEW FIELDS:
                'accommodation_date'          => $accDate,  // Y-m-d
                'accommodation_day_name'      => $accDay,   // Sunday, Monday...
                'property_day_id_fk'          => $property_day_id_fk, // packages_properties_days_id
