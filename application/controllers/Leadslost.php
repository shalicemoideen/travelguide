...
class Leadslost extends MY_Controller {
	public $table = 'leads';
	...
	public function __construct()
	{
	    ...
	    $this->currentusertype = $this->session->userdata('user_type');
            ...
            $this->load->model('Leadslost_model');
	}
	...
	public function index()
	{
		...
		$template['body'] = 'Leadslost/list';
		$template['script'] = 'Leadslost/script';
	...
	public function get_b2c(){
    	...
    	$data = $this->Leadslost_model->getManualB2CLeadsTable($param);
	...
	public function get_meta(){
    	...
    	$data = $this->Leadslost_model->getMetaLeadsTable($param);
    	$json_data = json_encode($data);
    	echo $json_data;
    }
	...
	public function get_b2b(){
    	...
    	$data = $this->Leadslost_model->getB2BLeadsTable($param);
    	$json_data = json_encode($data);
    	echo $json_data;
    }
