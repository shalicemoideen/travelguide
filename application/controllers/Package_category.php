...
class Package_category extends MY_Controller {
	...
	public function index()
	{
		...
		$template['category'] = $this->Package_category_model->fetch_package_category_details();
		$template['staff'] = $this->Package_category_model->fetch_staff_details();
		$template['body'] = 'Package_category/list';
		$template['script'] = 'Package_category/script';
	...
	public function get(){
    	...
    	$data = $this->Package_category_model->getPackagecategoryTable($param);
	...
	{
		$data = $this->Package_category_model->get_by_id($id);
	...
	public function checkpackage_category(){
            
			
            $package_category_name	 = $this->input->post('value');
            $data = $this->Package_category_model->checkpackage_category($package_category_name);
            // print_r($data);exit();
			$json_data = json_encode($data);
            echo $json_data;
            
	}
	 public function checkEditpackage_category(){
		
	 	
		$package_category_name = $this->input->post('value');
		$package_category_id = $this->input->post('id');
		$data = $this->Package_category_model->checkEditpackage_category($package_category_name, $package_category_id);
		$json_data = json_encode($data);
		echo $json_data;
	...
	public function delete()
	{
		...
		$updateData = array('package_category_status' => 0);
	...
	private function _validate()
	{
		...
		if($this->input->post('package_category_name') == '')
		{
			$data['inputerror'][] = 'package_category_name';
