...
var table1;
  $(document).ready(function() {
    ...
    $table1 = $('#B2C_Leads_table').DataTable( {
        ...
        "ajax": {
            "url": "<?php echo base_url();?>index.php/LeadsQualified/get_b2c/",
            "type": "POST",
            "data" : function (d) {
           ...
           $table1.column(0).nodes().each(function(node,index,dt){
            ...
            //   $('td', row).eq(9).html('<span class="badge badge-success">Converted to trip</span>');
              ...
              if(data['leads_accomodation_status'] == 0){
                ...
                $('td', row).eq(13).html('<div class="dropdown ms-auto text-end"><div class="btn-link" data-bs-toggle="dropdown"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg></div><div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="javascript:void(0)" id="rt" onclick="openChangeStatusModal('+data['leads_id']+')">Change stage</a><a class="dropdown-item" href="javascript:void(0)" id="rt" onclick="showStatusModal('+data['leads_id']+')">Show stages</a><a class="dropdown-item" href="javascript:void(0)" id="rt" onclick="openChangeStatus1Modal('+data['leads_id']+')">Change status</a><a class="dropdown-item" href="javascript:void(0)" id="rt" onclick="showStatus1Modal('+data['leads_id']+')">Status history</a></div></div>');
              }
              
              if(data['leads_accomodation_status'] == 1){

                $('td', row).eq(13).html('<div class="dropdown ms-auto text-end"><div class="btn-link" data-bs-toggle="dropdown"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg></div><div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="javascript:void(0)" id="rt" onclick="openChangeStatusModal('+data['leads_id']+')">Change stage</a><a class="dropdown-item" href="javascript:void(0)" id="rt" onclick="showStatusModal('+data['leads_id']+')">Show stages</a><a class="dropdown-item" href="javascript:void(0)" id="rt" onclick="openChangeStatus1Modal('+data['leads_id']+')">Change status</a><a class="dropdown-item" href="javascript:void(0)" id="rt" onclick="showStatus1Modal('+data['leads_id']+')">Status history</a><a class="dropdown-item" href="javascript:void(0)" id="rt" onclick="view_lead_details('+data['leads_id']+')">view</a></div></div>');
 ...
 var table2;
  $(document).ready(function() {
    ...
    $table2 = $('#meta_Leads_table').DataTable( {
        ...
        "ajax": {
            "url": "<?php echo base_url();?>index.php/LeadsQualified/get_meta/",
            "type": "POST",
            "data" : function (d) {
...
//            $('td',row).eq(0).html(index+1);
  ...
  $(document).ready(function() {
    ...
    $table3 = $('#B2B_table').DataTable( {
        ...
        "ajax": {
            "url": "<?php echo base_url();?>index.php/LeadsQualified/get_b2b/",
            "type": "POST",
            "data" : function (d) {
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ${buildLeadCard('Travel Information', [
                    ...
                    ['Accommodation Status', getAccommodationStatusText(d.leads_accomodation_status)]
                ])}
            </div>
