        ...
        "createdRow": function (row, data, dataIndex) {
            ...
            */
            ...
            if (hasPermission('INCLUSION_AND_EXCLUSION_UPDATE')) {
                actionHtml += '<a href="javascript:void(0)" onclick="edit_include_exclude('+data['inclusion_exclusion_common_id']+')" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>';
            }

            // Delete button
            if (hasPermission('INCLUSION_AND_EXCLUSION_DELETE')) {
                actionHtml += '<a href="javascript:void(0)" onclick="return delete_include_exclude('+data['inclusion_exclusion_common_id']+')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>';
            }
