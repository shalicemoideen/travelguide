                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="row row-demo-grid hdr-filter-dd-fullwd">
                                                <div class="col-sm-6 col-md-5">
                                                    <div class="card">
                                                        <div class="input-group">
                                                            <select data-validation="required"  data-pms-required="true" class="form-control input-lg lst-flt-select2" id="vehicle_id" name="vehicle_id" required>  
                                                                    ...
                                                                    foreach($vehicle as $row)
                                                                    {
                                                                        ...
                                                                        echo '<option value="'.$row->vehicle_id.'" '.$sel.'>'.$row->vehicle_name.'</option>';
                                                ...
                                                <div class="col-sm-6 col-md-5 staff-do-not-show">
                                                    <div class="card">
                                                        <div class="input-group">
                                                            <select name="vehicle_createdby_user_id" id="vehicle_createdby_user_id" class="form-control input-lg lst-flt-select2" required>                                     
