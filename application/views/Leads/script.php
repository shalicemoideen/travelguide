...
//            $('td',row).eq(0).html(index+1);
           $table1.column(0).nodes().each(function(node,index,dt){
            ...
            $table1.column(7).nodes().each(function(node, index, dt) {
        ...
        "columns": [
            ...
            { "data": "start_date", "orderable": false, "render": function(data, type, row) {
                ...
                return '<div style="line-height:1.6">' +
                    ...
                    '<div><span style="color:#e74a3b;font-weight:600;font-size:13px">' + (row.end_date || '-') + '</span></div>' +
...
//            $('td',row).eq(0).html(index+1);
           $table2.column(0).nodes().each(function(node,index,dt){
            ...
            $table2.column(7).nodes().each(function(node, index, dt) {
