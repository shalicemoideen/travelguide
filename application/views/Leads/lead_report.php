                ...
                <div class="d-flex align-items-center">
                    <div class="row row-demo-grid hdr-filter-dd-fullwd">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="From date" id="start_date" name="start_date">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="card">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="To date" id="end_date" name="end_date">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2 col-md-3">
                            <div class="card">
                                <a href="<?php echo base_url(); ?>index.php/Leads/lead_report">
