...
#roompricingandguestallocationModal .modal-content{border:none;border-radius:10px;overflow:hidden;}

#roompricingandguestallocationModal .rm-header{background:linear-gradient(135deg,#1a237e 0%,#3949ab 100%);padding:10px 16px;}

#roompricingandguestallocationModal .rm-header .modal-title{color:#fff;font-size:13px;font-weight:700;letter-spacing:.3px;}

#roompricingandguestallocationModal .rm-header .btn-close{filter:invert(1) brightness(2);}

#roompricingandguestallocationModal .modal-body{background:#f4f6fb;padding:12px;}

#roompricingandguestallocationModal .rm-info-card{background:#fff;border:1px solid #e3e8f7;border-radius:8px;padding:8px 12px;height:100%;}

#roompricingandguestallocationModal .rm-info-label{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#7986cb;margin-bottom:2px;}

#roompricingandguestallocationModal .rm-info-value{font-size:11px;font-weight:600;color:#1a237e;}

#roompricingandguestallocationModal .rm-sec-title{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.4px;color:#3949ab;padding:3px 0 3px 8px;border-left:3px solid #3949ab;margin-bottom:6px;}

#roompricingandguestallocationModal .table thead th{background:#e8eaf6;color:#283593;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.3px;border-bottom:2px solid #c5cae9;padding:5px 8px;}

#roompricingandguestallocationModal .table tbody td{font-size:11px;padding:4px 8px;vertical-align:middle;}

#roompricingandguestallocationModal .rm-auto-badge{background:#e8f5e9;color:#2e7d32;font-size:10px;font-weight:700;padding:2px 8px;border-radius:4px;display:inline-block;}

#roompricingandguestallocationModal .rm-manual-badge{background:#fff3e0;color:#e65100;font-size:10px;font-weight:700;padding:2px 8px;border-radius:4px;display:inline-block;}

#roompricingandguestallocationModal .rm-amt{background:#e8eaf6;color:#283593;font-size:10px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-block;margin-top:2px;white-space:nowrap;}

#roompricingandguestallocationModal .rm-total-auto{background:#e8f5e9;color:#1b5e20;font-size:12px;font-weight:700;padding:3px 10px;border-radius:6px;}

#roompricingandguestallocationModal .rm-total-manual{background:#fff3e0;color:#bf360c;font-size:12px;font-weight:700;padding:3px 10px;border-radius:6px;}

#roompricingandguestallocationModal .rm-remaining{background:#fff;border:1px solid #c5cae9;border-radius:8px;padding:6px 10px;display:flex;align-items:center;gap:6px;flex-wrap:wrap;}

#roompricingandguestallocationModal .rm-rem-label{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.4px;color:#5c6bc0;}

#roompricingandguestallocationModal .rm-rem-pill{display:inline-flex;align-items:center;gap:3px;padding:2px 8px;border-radius:20px;font-size:11px;font-weight:700;}
...
#roompricingandguestallocationModal .pax-chip{display:inline-flex;align-items:center;gap:3px;padding:2px 6px;border-radius:10px;font-size:11px;font-weight:600;margin:1px;}

#roompricingandguestallocationModal .pax-chip i{font-size:14px;line-height:1;}
...
#roompricingandguestallocationModal .modal-footer{background:#eef0ff;border-top:1px solid #c5cae9;padding:8px 12px;}

#roompricingandguestallocationModal .form-control-sm,
#roompricingandguestallocationModal .form-select-sm{font-size:11px;padding:3px 6px;min-height:28px;}
...
<input type="hidden" id="modal_baby_eb_count" value="0">
          ...
          <div class="mb-2">
            ...
            <div class="rm-sec-title">
              ...
              <button type="button" id="sync-btn" class="btn btn-sm ms-2" style="background:#3949ab;color:#fff;font-size:10px;padding:2px 8px;border-radius:4px;"><i class="la la-sync me-1"></i>Sync</button>
