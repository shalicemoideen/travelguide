...
//            $('td',row).eq(0).html(index+1);
           $table.column(0).nodes().each(function(node,index,dt){
            ...
            // Edit button
            if (hasPermission('SPECIAL_REQUIREMENTS_UPDATE')) {
                actionHtml += '<a href="javascript:void(0)" onclick="edit_special_requirements('+data['special_requirements_id']+')" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>';
            }

            // Delete button
            if (hasPermission('SPECIAL_REQUIREMENTS_DELETE')) {
                actionHtml += '<a href="javascript:void(0)" onclick="return delete_special_requirements('+data['special_requirements_id']+')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>';
            }
