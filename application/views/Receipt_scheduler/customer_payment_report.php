            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Customer Payment Report</h4>
                        <button type="button" class="btn btn-primary btn-sm" id="btnToggleFilters" onclick="toggleCustomerFilters()">
                            <i class="fas fa-filter me-1"></i> Filters
                        </button>
                    </div>
                    <div class="card-body">
                        <!-- Filters -->
                        <div id="customerFilterSection" class="row mb-3" style="display: none;">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" class="form-control" id="created_date_range" placeholder="dd/mm/yyyy - dd/mm/yyyy" autocomplete="off" readonly>
                            </div>
                            <div class="col-md-3 mb-2">
                                <label class="form-label">&nbsp;</label>
                                <div class="d-flex align-items-center">
                                    <button type="button" class="btn btn-primary btn-sm" onclick="applyCustomerReportFilters()">Apply</button>
                                    <button type="button" class="btn btn-secondary btn-sm ms-1" onclick="clearCustomerReportFilters()">Clear</button>
                                </div>
                            </div>
                        </div>

                        <style>
                            #customer_payment_report_table th,
                            #customer_payment_report_table td {
                                font-size: 13px;
                                padding: 6px 8px;
                                white-space: nowrap;
                            }
                            #customer_payment_report_table tbody tr {
                                transition: all 0.2s ease;
                            }
                            #customer_payment_report_table tbody tr:hover {
                        ...
                        <div class="table-responsive">
                            <table id="customer_payment_report_table" class="display" style="min-width: 900px">
                                <thead>
                                    <tr>
                                        <th>Sl.no</th>
                                        <th>Quotation #</th>
...
<div class="modal fade" id="viewSchedulerDetailsModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-3">
                        <strong>Quotation:</strong> <span id="cpd_quotation_number">-</span>
                    </div>
                    <div class="col-md-3">
                        <strong>Guest:</strong> <span id="cpd_guest_name">-</span>
                    </div>
                    <div class="col-md-3">
                        <strong>Type:</strong> <span id="cpd_payment_type">-</span>
                    </div>
                    <div class="col-md-3">
                        <strong>Total:</strong> <span id="cpd_total_amount">-</span>
                    </div>
                </div>
                ...
                <h6>Installments</h6>
                <div class="table-responsive">
                    <table class="table table-bordered table-sm" id="cpdInstallmentsTable">
