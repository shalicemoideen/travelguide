					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <?php if (has_permission('TEMPLATES_CREATE')): ?>
                    ...
                    <div class="modal-body">
                        ...
                        <form class="needs-validation" action="#" id="form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="itinerary_select_wrap">
                                    <div class="form-group">
                                        <label class="col-lg-7 col-form-label" for="packages_itinerary_id_fk">
                                            <b>Itinerary</b> <span class="text-danger">*</span>
                                        </label>
                                        <select name="packages_itinerary_id_fk" id="packages_itinerary_id_fk" class="form-control multi-select" required>
                                            <option value="">Please Select itinerary</option>
                                        </select>
                                ...
                                <div class="col-md-3" id="itinerary_display_wrap" style="display:none;">
                                    <div class="form-group">
