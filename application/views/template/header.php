...
<!-- Mirrored from travl.dexignlab.com/django/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Jul 2025 04:26:42 GMT -->
<head>
	<meta charset="utf-8">
	...
	<meta property="og:description" content="Travel CRM Software" />
		...
		***********************************-->
		<div class="nav-header">
			<a href="#" >
				...
				<a href="#"><img src="<?php echo base_url();?>assets/images/Royale-logo-new.png" style="width:210px;height:82px;" alt=""></a>
			</a>
						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown header-profile">
								<?php
									...
									<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
										<img src="<?php echo base_url();?>assets/images/user.png" width="20" alt=""/>
									</a>
									...
									<?php } else { ?>
										...
										<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
											<img src="<?php echo base_url();?>uploads/user-profile/<?php echo $this->session->userdata('user_profile_pic');?>" width="20" alt=""/>
										</a>
										<!-- <img src="<?php echo base_url();?>uploads/user-profile/<?php echo $this->session->userdata('user_profile_pic');?>" alt="..." class="avatar-img rounded-circle"> -->
								...
								<div class="dropdown-menu dropdown-menu-end">
									<a href="<?php echo base_url();?>index.php/User/" class="dropdown-item ai-icon">
									...
									<a href="<?php echo base_url();?>index.php/Login/logout" class="dropdown-item ai-icon">
