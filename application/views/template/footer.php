<!--**********************************
		...
		***********************************-->
		<div class="footer">
			<div class="copyright">
				<p>Copyright © Designed &amp; Developed by <a href="https://magnussofttech.com/" target="_blank">Magnus Technologies</a> 2026</p>
			</div>
		</div>
		<!--**********************************
			Footer end
   ...
   <!-- <script src="https://cdn.ckeditor.com/ckeditor5/39.0.1/super-build/ckeditor.js"></script> -->
	...
	<script>
		...
		$(document).ready(function () {
			...
			if (!currentUserId || currentUserId === "" || currentUserId === "null") {
		...
		// 		$.ajax({
		// 			url: "<?php echo base_url(); ?>index.php/Login/check_session",
		// 			method: "GET",
		// 			dataType: "json",
