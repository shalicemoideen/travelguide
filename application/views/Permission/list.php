					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a onclick="add_permission()"  data-bs-target="#PermissionModal" class="btn btn-rounded btn-secondary btn-md">+ New permission</a> 
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="Permission_table" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                <th>Sl.no</th>
                                                <th>Name</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" onclick="PermissionModalclose()" data-bs-dismiss="modal">
                        </button>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-9">
                                    <div class="mb-3 row form-group">
                                        <label class="col-lg-4 col-form-label" for="permission_name">Name
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-8 permission_name">
                                            <input type="text" class="form-control" name="permission_name" id="permission_name" placeholder="Enter Permission" required>
                                            <span class="help-block" style="color:red"></span>
                                            <b><span id="permission_name_alert" style="color: red"></span></b>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="permission_description">Description 
                                        </label>
                                        <div class="col-lg-8">
                                            <textarea class="form-control" name="permission_description" id="permission_description"  rows="5" placeholder="Enter Description" required></textarea>
                                    ...
                                    <div class="mb-3 row form-group">
                                        <label class="col-lg-4 col-form-label" for="permission_status">Status 
                                        </label>
                                        <div class="col-lg-8">
                                                <div class="input-group">
                                                    <select data-validation="required"  data-pms-required="true" class="form-control input-lg lst-flt-select2" id="permission_status" name="permission_status" required>  
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger light" onclick="PermissionModalclose()" data-bs-dismiss="modal">Close</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" action="#" id="form1" >
                    ...
                    <input type="hidden" value="" name="permission_name" id="state_name1"/>
