        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                ...
                <form id="incentiveReportFilterForm" method="POST" action="">
                    <input type="hidden" id="incentive_report_date_type" name="incentive_report_date_type" value="arrival">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="row row-demo-grid hdr-filter-dd-fullwd">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Date Range" id="incentive_report_daterange" name="incentive_report_daterange" readonly>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title"><b>Incentive Report</b></h2>
                            </div>
                            <div class="card-body">
