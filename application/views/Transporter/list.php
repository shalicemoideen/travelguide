                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="row row-demo-grid hdr-filter-dd-fullwd">
                                                <div class="col-sm-6 col-md-5">
                                                    <div class="card">
                                                        <div class="input-group">
                                                            <select data-validation="required"  data-pms-required="true" class="form-control input-lg lst-flt-select2" id="transporter_id" name="transporter_id" required>  
                                                                    ...
                                                                    foreach($transporter as $row)
                                                                    {
                                                                        ...
                                                                        echo '<option value="'.$row->transporter_id.'" '.$sel.'>'.$row->transporter_name.'</option>';
                                                ...
                                                <div class="col-sm-6 col-md-5">
                                                    <div class="card">
                                                        <div class="input-group">
                                                            <select data-validation="required"  data-pms-required="true" class="form-control input-lg lst-flt-select2" id="transporter_base_station_id_fk1" name="transporter_base_station_id_fk" required>  
                                                ...
                                                <div class="col-sm-6 col-md-5">
                                                    <div class="card">
                                                        <div class="input-group">
                                                            <select data-validation="required"  data-pms-required="true" class="form-control input-lg multi-select" id="vehicle_id_fk1" name="vehicle_id_fk"  multiple="multiple" required>  
                                                ...
                                                <div class="col-sm-6 col-md-5 staff-do-not-show">
                                                    <div class="card">
                                                        <div class="input-group">
                                                            <select name="transporter_createdby_user_id" id="transporter_createdby_user_id" class="form-control input-lg lst-flt-select2" required>                                     
                                ...
                                <div class="col-md-3">
                                    <div class=" form-group">
                                        <label class="col-lg-3 col-form-label" for="transporter_name">Name <span class="text-danger">*</span>
                                            ...
                                            <input type="text" class="form-control" name="transporter_name" id="transporter_name" placeholder="Enter agent name" required>
