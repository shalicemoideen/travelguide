...
<!--**********************************
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="row row-demo-grid hdr-filter-dd-fullwd">
                                                <div class="col-sm-6 col-md-5">
                                                    <div class="card">
                                                        <div class="input-group">
                                                            <select data-validation="required"  data-pms-required="true" class="form-control input-lg lst-flt-select2" id="payment_policies_id" name="payment_policies_id" required>  
                                                ...
                                                <div class="col-sm-6 col-md-5 staff-do-not-show">
                                                    <div class="card">
                                                        <div class="input-group">
                                                            <select name="payment_policies_createdby_user_id" id="payment_policies_createdby_user_id" class="form-control input-lg lst-flt-select2" required>                                     
                                                ...
                                                <div class="col-sm-2 col-md-3">
                                                    <div class="card">
                                                        <a href="<?php echo base_url();?>Payment_policies">
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Payment policies Details</h4>
                                <?php if (has_permission('PAYMENT_POLICY_CREATE')): ?>
                                        <a onclick="add_Payment_policies()"  data-bs-target="#Payment_policiesModal" class="btn btn-rounded btn-secondary btn-md">+ New Payment policies</a> 
                                <?php endif; ?>                                    
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="Payment_policies_table" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                <th>Sl.no</th>
                                                <th>Name</th>
        ...
        ***********************************-->
        ...
        <!-- Modal -->
        <div class="modal fade" id="Payment_policiesModal" role="dialog" data-backdrop="static"  data-keyboard="false">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"></h5>
                        <button type="button" class="btn-close" onclick="Payment_policiesmodalclose()" data-bs-dismiss="modal">
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <form class="needs-validation" action="#" id="form" >
                            ...
                            <input type="hidden" name="removed_payment_policies_id" id="removed_payment_policies_id"  value=""/>
                            <div class="row">
                                <div class="col-md-8">
                                    <div class=" form-group">
                                        <label class="col-lg-3 col-form-label" for="payment_policies_name">Name <span class="text-danger">*</span>
                                        </label>
                                        
                                            <input type="text" class="form-control" name="payment_policies_name" id="payment_policies_name" placeholder="Enter payment policies name" required>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger light" onclick="Payment_policiesmodalclose()" data-bs-dismiss="modal">Close</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" action="#" id="form1" >
                    ...
                    <input type="hidden" value="" name="payment_policies_name" id="payment_policies_name1"/>
                    
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger light" onclick="Transportermodalclose()" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="btnSave1" onclick="delete_payment_policies_action()" >Delete</button>
            </div>
        </div>
    </div>
</div>