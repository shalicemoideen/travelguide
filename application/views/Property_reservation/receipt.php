...
<head>
    ...
    <style>
        ...
        .receipt-container { max-width: 700px; margin: 0 auto; background: #fff; border: 1px solid #dee2e6; padding: 40px; box-shadow: 0 0 15px rgba(0,0,0,0.05); }
        .receipt-header { border-bottom: 2px solid #343a40; padding-bottom: 20px; margin-bottom: 25px; }
        .receipt-title { font-size: 1.75rem; font-weight: 700; margin-bottom: 5px; }
        .receipt-meta { font-size: 0.95rem; color: #6c757d; }
        .receipt-row { margin-bottom: 10px; }
        .receipt-label { font-weight: 600; color: #495057; }
        .receipt-amount { font-size: 1.5rem; font-weight: 700; color: #198754; }
        .receipt-footer { margin-top: 40px; padding-top: 20px; border-top: 1px solid #dee2e6; font-size: 0.9rem; color: #6c757d; }
        ...
        <div class="receipt-container">
            <div class="receipt-header d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="receipt-meta">Receipt No: PR-<?php echo str_pad($payment->payment_id, 6, '0', STR_PAD_LEFT); ?></div>
                </div>
            ...
            <div class="row receipt-row">
                <div class="col-md-6">
                    ...
                    <?php echo htmlspecialchars($scheduler ? $scheduler->quotation_number : '-'); ?>
                </div>
                <div class="col-md-6 text-md-right">
                    <span class="receipt-label">Guest:</span>
                    <?php echo htmlspecialchars($scheduler ? $scheduler->guest_name : '-'); ?>
                </div>
            </div>
            ...
            <div class="row receipt-row">
                <div class="col-md-6">
                    ...
                    EMI <?php echo $installment ? $installment->installment_number : '-'; ?>
                </div>
                <div class="col-md-6 text-md-right">
                    <span class="receipt-label">Due Date:</span>
                    <?php echo ($installment && $installment->due_date) ? date('d/m/Y', strtotime($installment->due_date)) : '-'; ?>
                </div>
            </div>
            ...
            <div class="receipt-footer">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?php echo htmlspecialchars($payment->payment_paid_by_username ?: '-'); ?>
                    </div>
                    <div class="col-md-6 text-md-right">
                        <span class="receipt-label">Total Schedule Amount:</span><br>
                        &#8377;<?php echo $scheduler ? number_format((float)$scheduler->total_amount, 2) : '0.00'; ?>
                    </div>
                </div>
