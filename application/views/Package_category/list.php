                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="row row-demo-grid hdr-filter-dd-fullwd">
                                                <div class="col-sm-6 col-md-5">
                                                    <div class="card">
                                                        <div class="input-group">
                                                            <select data-validation="required"  data-pms-required="true" class="form-control input-lg lst-flt-select2" id="package_category_id" name="package_category_id" required>  
                                                ...
                                                <div class="col-sm-6 col-md-5 staff-do-not-show">
                                                    <div class="card">
                                                        <div class="input-group">
                                                            <select name="package_category_createdby_user_id" id="package_category_createdby_user_id" class="form-control input-lg lst-flt-select2" required>                                     
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a onclick="add_category()"  data-bs-target="#PackagecategoryModal" class="btn btn-rounded btn-secondary btn-md">+ New category</a> 
                            </div>
                            <div class="card-body">
